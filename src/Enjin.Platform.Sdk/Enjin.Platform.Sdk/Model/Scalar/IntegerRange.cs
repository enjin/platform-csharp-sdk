...
/// <summary>
/// Represents an inclusive range between two <see cref="BigInteger"/> values.
/// </summary>
[JsonConverter(typeof(IntegerRangeJsonConverter))]
[PublicAPI]
public readonly struct IntegerRange
{
    ...
    public IntegerRange(BigInteger value) : this(value, value)
    {
    }
    ...
    /// </exception>
    public IntegerRange(BigInteger start, BigInteger end)
    {
        if (start > end)
        {
